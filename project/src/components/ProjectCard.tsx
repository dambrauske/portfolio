            ...
            <div className="w-1/2 flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4">
                            {project.frontLink &&
                                    <a href={project.frontLink} target="_blank" className="border-2 py-1 px-2 text-teal-300 rounded-full hover:bg-teal-300 hover:text-zinc-900 duration-200 flex justify-center items-center gap-1">
                        ...
                        {project.backLink &&
                            ...
                            <a href={project.backLink} target="_blank" className="border-2 py-1 px-2 text-teal-300 rounded-full hover:bg-teal-300 hover:text-zinc-900 duration-200 flex justify-center items-center gap-1">
